...
import { removeProduct, storeStripeData } from "../redux/cartRedux";
              ...
              <Product>
                <ProductDetail>
                  ...
                  <Details>
                    ...
                    <Button onClick={() => handleRemoveClick(product._id)} 
                     style={{width:100, cursor: 'pointer', marginTop: 30}}>Remove</Button>
                  </Details>
                </ProductDetail>
                <PriceDetail>
